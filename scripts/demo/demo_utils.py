...
def load_model(ckpt_path: str, load_text_encoder: bool = False, exp_name: str = "gem_smpl"):
    ...
    Args:
        ...
        exp_name: hydra experiment name to override
    ...
    if load_text_encoder:
        ...
        overrides.append("model.model_cfg.text_encoder.load_llm=false")
